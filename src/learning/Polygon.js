...
function Polygon({changePageController}) {
    ...
    try {
        ...
        unityContext.send("Quest", "updatevals", 1);
  ...
  return (
    ...
    <div className='my-4 mx-4'>
      <p className='text-base mb-4'>Polygon is a Layer-2 scaling solution created to help bring mass adoption to the Ethereum platform. It caters to the diverse needs of developers by providing tools to create scalable decentralized applications 
      (dApps) that prioritize performance, user experience (UX), and security. </p>
       ...
       className="max-w-sm ml-4 mt-4 bg-[#00b8d5] rounded-xl py-2 px-6 text-[#0067d5] font-bold">Get MATIC using Transak</button>
