...
function Aave({ changePageController }) {
  ...
  const reward = async () => {
    ...
    try {
      ...
      unityContext.send("Quest", "updatevals", 4);
  ...
  return (
    <div>
      ...
      <div className='my-4 mx-4'>
        <p className='text-base mb-4'>Aave is a decentralized finance (DeFi) protocol that lets people lend and borrow cryptocurrencies and real world assets (RWAs) without having to go through a centralized intermediary. 
        When they lend, they earn interest; when they borrow, they pay interest.</p>
        <h2 className='font-bold text-base mb-4'>About the Quest</h2>
        <p className='text-base mb-4'>Deposit $5 in Aave V1 protocol to claim rewards</p>
      </div>
