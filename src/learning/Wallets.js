...
function Uniswap({ changePageController }) {
  ...
  const reward = async () => {
    ...
    try {
      ...
      unityContext.send("Quest", "updatevals", 0);
  ...
  return (
    <div>
      ...
      <div className='my-4 mx-4'>
        <p className='text-base mb-4'>Web3 requires the use of wallets that store your digital assets and tokens. They form an important part of the web3 ecosystem. 
        A few options include Coinbase wallet, WalletConnect and Metamask.
        </p>
